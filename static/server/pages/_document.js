...
// EXTERNAL MODULE: ./src/utilities/createEmotionCache.ts + 1 modules
var createEmotionCache = __webpack_require__(3540);
...
class UltraDocument extends next_document["default"] {
    render() {
...
UltraDocument.getInitialProps = async (ctx)=>{
    // Resolution order
    //
    // On the server:
...
var __webpack_exports__ = __webpack_require__.X(0, [859], () => (__webpack_exec__(4088)));
